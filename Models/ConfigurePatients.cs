        ...
        public void Configure(EntityTypeBuilder<Patient> entity)
        {
            ...
            entity.HasData(
                ...
                new Patient
                {
                    ...
                    PatientDOB = DateTime.Parse("2000-02-12")
                },
                new Patient
                {
                    PatientID = 3,
                    ...
                    PatientDOB = DateTime.Parse("2000-03-13")
                },
                new Patient
                {
                    PatientID = 4,
                ...
                new Patient
                {
                    ...
                    PatientDOB = DateTime.Parse("2000-06-16")
                },
                new Patient
                {
                    PatientID = 7,
                ...
                new Patient
                {
                    ...
                    PatientDOB = DateTime.Parse("2000-09-19")
                },
                new Patient
                {
                    PatientID = 10,
                    ...
                    PatientDOB = DateTime.Parse("2000-10-20")
                },
                new Patient
                {
                    PatientID = 11,
                    ...
                    PatientDOB = DateTime.Parse("2000-11-21")
                },
                new Patient
                {
                    PatientID = 12,
                    ...
                    PatientDOB = DateTime.Parse("2000-12-22")
                },
                new Patient
                {
                    PatientID = 13,
                ...
                new Patient
                {
                    ...
                    PatientSSN = "123456789",
                    PatientDOB = DateTime.Parse("2000-02-24")
                },
                new Patient
                {
                    PatientID = 15,
                    ...
                    PatientSSN = "123456789",
                    PatientDOB = DateTime.Parse("2000-03-25")
                }
            );
        }
    }
